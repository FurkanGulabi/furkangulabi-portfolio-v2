...
const ProjectCard = ({
  ...
  const [imageSrc, setImageSrc] = useState<string>(image[defaultKey]);

  // Update image source on client-side only after hydration
  useEffect(() => {
    ...
    >
      <div className="relative overflow-hidden aspect-video">
        <Image
          ...
          aria-hidden="false"
          role="img"
          onError={() => setImageSrc(image[defaultKey])}
        />
      </div>
